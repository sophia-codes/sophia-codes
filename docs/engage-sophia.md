...
- reviewing plans
- maintaining execution clarity across weeks or months
...
- a small set of relevant documents or issues
...
- outputs remain reviewable in the places where the work lives
...
- anything that should change before merge
```
...
- there is code, but not enough clarity
